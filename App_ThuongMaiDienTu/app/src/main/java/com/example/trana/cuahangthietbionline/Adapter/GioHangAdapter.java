...
import com.example.trana.cuahangthietbionline.View.GioHang;
...
public class GioHangAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(viewHolder==null){
            ...
            viewHolder.imggiohang=convertView.findViewById(R.id.imagivewanhgiohang);
            viewHolder.bttvalues=convertView.findViewById(R.id.buttongiohangvalues);
            viewHolder.bttminus=convertView.findViewById(R.id.buttongiohangminus);
            viewHolder.bttplus=convertView.findViewById(R.id.buttongiohangplus);
